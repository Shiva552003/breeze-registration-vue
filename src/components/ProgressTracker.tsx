      ...
      <div className="relative flex items-center justify-between mb-8 px-4">
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="relative flex flex-col items-center z-10">
            {/* Step Circle */}
            <div
              className={`relative w-12 h-12 rounded-full flex items-center justify-center border-3 transition-all duration-500 ease-out transform ${
                step.id < currentStep
            ...
            {index < steps.length - 1 && (
              <div className="absolute top-6 left-12 w-full">
                <div
